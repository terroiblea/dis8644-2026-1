...
- Tienden a desplazarse hacia el **lado positivo (+)**
- El movimiento de electrones genera la **corriente eléctrica**.
...
- Filas conectadas internamente
- Líneas de energía en los lados
...
**Tinkercad** es una plataforma online para:

- Simular circuitos
- Crear proyectos electrónicos
